...
function Navbar() {
  ...
  return (
    <header className="sticky  top-0 z-5000 shadow-md  ">
      <section
        className={`sticky top-0 z-50 shadow-md w-full transition-all duration-300 ${
          isScrolled ? "bg-none" : ""
        }`}
        style={
          !isScrolled
            ? {
                background:
                  "linear-gradient(90deg, rgb(84, 6, 84), rgb(204, 13, 133) 50%, rgb(84, 6, 84) 100%)",
              }
            : {}
        }
      >
        <div className="navbar z-10 shadow-sm px-4    mx-auto  ">
          <div className="navbar-start">
            <div className="flex justify-center items-center">
              ...
              <img
                ...
                src="https://i.ibb.co/pvbBFDjN/download.jpg"
                alt=""
              />
            ...
            <div className="dropdown">
              ...
              >
                <li>
                    <NavLink
                      to="/"
                      className="hover:text-blue-500  font-bold text-xl"
                    >
                      Home
                    </NavLink>
                </li>
          ...
          <div className="navbar-end">
            ...
            <div>
              {user ? (
                <Link onClick={logOutUser} className="btn btn-primary ">
                  LogOut
                </Link>
              ) : (
                <>
